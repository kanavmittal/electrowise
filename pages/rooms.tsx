...
import AddRoomSlideover from "../components/slideovers/addRoomSlideover";
    ...
    <div className="h-screen bg-gray-100">
      <header className="relative flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200">
        <h1 className="text-xl font-semibold text-gray-900">
          <time dateTime="2022">Your Rooms</time>
        </h1>
      ...
      <div className="px-4 mx-auto mt-5 max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          {rooms.map((room) => (
            <SingleRoomCard key={room.id} room={room} roomId={room.id}></SingleRoomCard>
          ))}
        </ul>
      </div>
      <AddRoomSlideover
